    ...
    public class Startup{
        ...
        public void ConfigureServices(IServiceCollection services){
            services.AddDbContext<PruebaContext>(builder =>{
                var connStr = Configurations["Data:SqlServerConnectionString"]?? "Data Source=.;Initial Catalog=Prueba_Desarrollador;Persist Security Info=True;App=Prueba_Desarrollador";
